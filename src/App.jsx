                ...
                <p className="text-[11px] font-mono-editor mt-3 tracking-wider">
                  {!username ? (
                    ...
                    <span className="text-[#35d490]">
                      [✓] PROFILE LINKED →{' '}
                      {isTwitter && (
                        <a href={`https://x.com/${username}`} target="_blank" rel="noopener noreferrer" className="hover:underline">
                          x.com/{username}
                        </a>
                      )}
                      {isTwitter && isInstagram && ' · '}
                      {isInstagram && (
                        <a href={`https://instagram.com/${username}`} target="_blank" rel="noopener noreferrer" className="hover:underline">
                          ig/{username}
                        </a>
                      )}
                    </span>
                  ) : (
                    <span className="text-[#a0a0aa]">// TOGGLE X OR IG TO DRIVE TRAFFIC BACK</span>
                  )}
                </p>
              </div>
            </div>
